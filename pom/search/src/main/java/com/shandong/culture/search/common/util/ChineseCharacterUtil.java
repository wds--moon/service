package com.shandong.culture.search.common.util;
...
/**
* @Description:    汉字转拼音提取工具
* @Author:         moon
* @CreateDate:     2019/5/10 0010 09:47
* @UpdateUser:     moon
* @UpdateDate:     2019/5/10 0010 09:47
* @UpdateRemark:   修改内容
* @Version:        1.0
*/
public class ChineseCharacterUtil {
    ...
    public static void main(String[] args) {
        System.out.println(convertHanzi2Pinyin("DF-F-焦山北部",false).toUpperCase());
    }
